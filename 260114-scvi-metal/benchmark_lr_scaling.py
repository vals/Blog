"""
Benchmark scVI training with linear learning rate scaling.
LR scales proportionally with batch size: lr = base_lr * (batch_size / base_batch_size)
"""
import time
import pandas as pd
...
results_path = f"{OUTPUT_DIR}/benchmark_lr_scaling_results.csv"
results_df.to_csv(results_path, index=False)
print(f"\nResults saved to: {results_path}")

# Print summary
print("\n" + "="*60)
print("TIMING & FINAL LOSS SUMMARY (with LR scaling)")
print("="*60)
for batch_size in BATCH_SIZES:

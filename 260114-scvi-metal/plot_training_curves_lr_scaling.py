"""
Plot training curves from scVI batch size benchmark with LR scaling.
"""
import pandas as pd
...
# Load results
results_df = pd.read_csv(f"{OUTPUT_DIR}/benchmark_lr_scaling_results.csv")
...
# Save plot
output_path = f"{OUTPUT_DIR}/training_curves_lr_scaling.png"
